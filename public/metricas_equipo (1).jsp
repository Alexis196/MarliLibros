<style>
  ...
  /* Una sola card: centrada al 50% */
  .contenedor-tarjetas-seg:not(.contenedor-tarjetas2-seg) {
  ...
  /* En mobile, la card única ocupa el 100% igual */
...
<script>
  (function() {
    function animarBarra(id) {
      ...
      if (!barra) return;
      var targetWidth = barra.getAttribute('aria-valuenow') || '0';
      barra.style.width = '0%';
      requestAnimationFrame(function() {
        requestAnimationFrame(function() {
          barra.style.transition = 'width 0.9s cubic-bezier(0.4, 0, 0.2, 1)';
    ...
    document.addEventListener('DOMContentLoaded', function() {
      animarBarra('barraDirecto');
      animarBarra('barraIndirecto');
    });
  })();
</script>
